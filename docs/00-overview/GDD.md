...
A battle consists of 1 Player, 1 selected Pet, 1 Boss, 1 Match-3 board,
3 Basic Cards, 1 Pet Skill Card, and 3–5 Relics.

The player may own many Pets but uses exactly one Pet per battle.
...
(1–50), Stats, a Passive, and one Signature Skill.
...
Skills. It is generated by matching POWER Gems, Special Matches, and Relics.
...
Relics passively modify the player's build; MVP allows 3–5 equipped Relics.
...
Player and Boss combat stats include HP, Max HP, ATK, DEF, Power, Crit, and
Status Effects. Damage conceptually flows through Base Damage → Combo
Modifier → Element Modifier → Other Modifiers → Defense → Final Damage.
...
MVP persistent systems: Player, Pet Collection, Pet progression, Card
Collection, Relic Collection, Battle Results, Rewards.
